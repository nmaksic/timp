...
class DashUpdateHeader : public Header
{
public:
  DashUpdateHeader (void);
...
private:
  ...
  uint64_t m_version; // probe version for loop prevention, name version is used in the Dash paper
};


class DashTag : public Tag
{
public:
  /**
...
class DashPacketTag : public Tag
{
public:
  /**
   * \brief Get the type ID.
