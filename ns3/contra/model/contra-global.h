...
#ifndef CONTRA_GLOBAL_H
#define CONTRA_GLOBAL_H
...
class ContraGlobal : public Object
{
public:
...
private:
  ...
  bool m_enabled;          
  std::vector< Ptr<Contra> > m_sabLayers;
  std::list< int > torsws;

  std::vector<Ptr<Contra>> rtrpointers;

  Ptr<Contra> GetContraRouting (Ptr<Ipv4> ipv4) const;
